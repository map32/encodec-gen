...
class LitAutoEncoder(pl.LightningModule):
    def __init__(self, codebook_size=1024, codebook_num=8, length_per_codebook=512, model_dim=128, model_depth = 6, num_chunks = 2, steps=50, batch_size=4, lr=5e-4):
        super().__init__()
...
cached_path = '/content/saved_encodings'
